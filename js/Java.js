$(document).ready(function(){
    ...
    if (localStorage.getItem('userdetails') === null) {  
        var userDetails = {firstName:"Jimmy", lastName:"Timmy", dob:"1990-12-01",address1:"Kilconney", address2:"5 Annagh Park", address3:"Co. Cavan"};
    ...
    $('form[name="login"]' ).submit(function( event ) {
        ...
        if (email=="JimmyTimmy@gmail.com" && password=="Pass101")  {   
